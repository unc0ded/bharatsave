package com.bharatsave.goldapp.view.story
...
import com.bharatsave.goldapp.custom_widget.story.PausableProgressView
import com.bharatsave.goldapp.databinding.ActivityStoryContainerBinding
import com.bharatsave.goldapp.model.StoryModel
import com.bharatsave.goldapp.view.main.MainActivity
...
class StoryContainerActivity : AppCompatActivity() {
    ...
    private fun setupViews() {
        ...
        binding.ivStory.setOnTouchListener { _, event ->
            if (event != null) {
                when (event.action) {
